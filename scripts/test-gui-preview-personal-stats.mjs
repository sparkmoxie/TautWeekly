...
assert.ok(normal.includes(".stats-media-card .watched-list,.stats-summary-grid{grid-template-columns:1fr}"), "mobile preview does not reduce personal media cards to one title per row");
...
console.log("[PASS] GUI preview personal stats are uncapped, rated when eligible, adaptive, and network-local.");
