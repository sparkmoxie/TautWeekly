...
assert.match(productionCSS, /[.]tailscale-status-button [.]tailscale-logo{[^}]*fill:#f0f0f0/);
assert.match(productionCSS, /[.]tailscale-status-button [.]tailscale-logo path{opacity:[.]2/);
