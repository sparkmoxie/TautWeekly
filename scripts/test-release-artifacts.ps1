...
function Assert-RendererContract([string]$PackageName, [string]$Renderer) {
    ...
    Assert-True ($Renderer.Contains('class="stats-title-cell" width="50%"') -and $Renderer.Contains('.stats-title-cell { display:block !important; width:100% !important;')) "$PackageName lacks the responsive two-column personal-title grid."
