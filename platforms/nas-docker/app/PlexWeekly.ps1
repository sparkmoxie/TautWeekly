...
# PlexWeekly NAS Portable v1.0.4 — Linux container production newsletter engine.
...
if ($PSVersionTable.PSVersion -lt [Version]"7.2") {
    throw "PlexWeekly NAS Portable requires PowerShell 7.2 or newer. Found $($PSVersionTable.PSVersion)."
}
