...
var diagnosticSummaries = map[string]string{
	...
	"discovery-libraries-failed":       "Live Tautulli library discovery failed; any prior sanitized choice cache was left unchanged.",
	"discovery-users-failed":           "Live Tautulli user discovery failed; any prior sanitized choice cache was left unchanged.",
	"discovery-connection-failed":      "Live Tautulli discovery could not reach or use the saved service; any prior sanitized choice cache was left unchanged.",
...
var remoteAccessDiagnosticSummaries = map[string]string{
	...
	"tailscale-serve-conflict":              "An existing Tailscale route was not owned by TautWeekly and was left unchanged.",
	"tailscale-disable-incomplete":          "The Manager kept its password boundary because the owned Funnel route still needs verified cleanup.",
	"tailscale-unavailable":                 "Tailscale was not installed, connected, or available to the Manager user.",
	"tailscale-approval-required":           "Windows administrator approval was required to inspect or change Tailscale Funnel.",
	"tailscale-host-authorization-required": "The package administrator has not authorized TautWeekly's fixed Tailscale adapter.",
	"tailscale-approval-declined":           "Windows administrator approval was cancelled before Tailscale Funnel changed.",
	"tailscale-provider-approval-required":  "Tailscale required one-time provider approval before public Funnel could be enabled.",
	"tailscale-sign-in-required":            "Tailscale must be signed in before public Funnel can be configured.",
	"tailscale-verification-failed":         "Tailscale did not retain the exact Funnel route expected by TautWeekly.",
	"remote-access-state-write-failed":      "The public Funnel setting could not be saved safely.",
	"tailscale-disabled":                    "Tailscale Funnel was disabled.",
	"tailscale-enabled":                     "Tailscale Funnel was enabled and verified.",
	"tailscale-verified":                    "Tailscale route status was explicitly inspected without changing it.",
