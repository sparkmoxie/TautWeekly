...
func configDefinitions() []configDefinition {
	...
	return []configDefinition{
		...
		{Name: "SendDelaySeconds", Label: "Send delay (seconds)", Group: "Newsletter", Type: "integer", Required: true, Default: int64(10), Min: delayMin, Max: delayMax},
		{Name: "TestSendDelaySeconds", Label: "Test-send delay (seconds)", Group: "Newsletter", Type: "integer", Required: true, Default: int64(2), Min: delayMin, Max: delayMax},
